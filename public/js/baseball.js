...
// filter by american league
  $("#american-button").click(function(){
    $("#division-lists-container li").remove();
    ...
    for(var i=0;i<american.length;i++){
      ...
      $("#" + division +">ol").append("<li class='"+american[i].id+"''>"+american[i].id.replace(/-/g," ").toUpperCase()+"</li>")
    };
  });
  ...
  $("#national-button").click(function(){
    ...
    for(var i=0;i<national.length;i++){
      ...
      $("#" + division +">ol").append("<li class='"+national[i].id+"''>"+national[i].id.replace(/-/g," ").toUpperCase()+"</li>").show("slow")
    };
  });
